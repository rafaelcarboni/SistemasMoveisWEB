  ...
  <div class="row content">
    <div class="col-sm-3 sidenav">
      ...
      <ul class="nav nav-pills nav-stacked">
        ...
        <li class="active"><a href="edit.php">Editar um Cliente</a></li>
    ...
    <div class="col-sm-9">
      <h5>Projetos Sistemas Móveis</h5><br>
        ...
        <form class="form-horizontal" method="post" action="editar.php">
            <div class="form-group">
              <div class="col-sm-5">
                <input type="hidden" class="form-control" id="id1" value="<?php echo $id1 ?>" name="id1"  maxlength="11">
              </div>
            </div>
            <div class="form-group">
              <div class="col-sm-5">
                <input type="text" class="form-control" id="cpf" value="<?php echo $cpf1 ?>" name="cpf" maxlength="11" disabled>
              </div>
            </div>
            <div class="form-group">
              <div class="col-sm-5">
            ...
            <div class="form-group">
              <div class="col-sm-5">
                <input type="text" class="form-control" id="telefone" value="<?php echo $telefone ?>" name="telefone"  maxlength="11">
              </div>
            </div>
            <div class="form-group">        
              <div class="col-sm-5">
